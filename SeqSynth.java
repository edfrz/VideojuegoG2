...
public class SeqSynth implements MetaEventListener 
{
  ...
  public SeqSynth()
  {
    ...
    /*try { 
      ...
      System.out.println("Deberias dormir, Tocayo");
    } 
  ...
  */
  { changeInstrument(0,33);    // set bank and program; bass
    addRest(8);
    changeInstrument(0,1);
    add("F4"); add("D4"); add("F4"); add("D4"); add("A4");
    add("F5"); add("F4"); add("A4"); add("C5"); add("F5");
    
    
    addRest(7);
    add("F4"); add("F4#"); add("F4"); 
    add("C4#"); add("D4#", 3);  add("F4"); add("G4#"); 
    add("F4#"); add("F4"); add("D4#"); add("F4#", 3); 
    add("G4#"); add("C5#"); add("C5"); add("A4#"); 
    add("G4#"); add("A4#", 4); add("G4", 4); add("G4#", 2);
    changeInstrument(0,12);   // dulcimer
    addRest(1);
